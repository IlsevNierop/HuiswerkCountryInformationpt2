...
function errorHandling(e) {
    ...
    if (e === undefined) errorMessage.textContent = "This country doesn't exist, please try again. Or you've chosen Antarctica. This country cannot be displayed. | 404";
    else if (e.response.status === 404) errorMessage.textContent = "This country doesn't exist, please try again | 404";
...
function generateStringFromArray(array, stringToAddBehindName) {
    if (array === undefined) return "nothing";
    let s = "";
    for(let i = 0; i < array.length; i++){
        s += `${array[i].name}${stringToAddBehindName}`;
        if (i < array.length - 2) s += ", ";
        if (i === array.length - 2) s += " and ";
    }
    return s;
}
...
var Buffer = require("979656894876c371").Buffer;
"use strict";
/**
...
},{"979656894876c371":"fCgem","../utils.js":"5By4s","../core/AxiosError.js":"3u8Tl","../platform/node/classes/FormData.js":"aFlee","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fCgem":[function(require,module,exports) {
/*!
...
var base64 = require("28ab9c724fe924cb");
var ieee754 = require("b8743149fbe0f9a1");
...
},{"28ab9c724fe924cb":"eIiSV","b8743149fbe0f9a1":"cO95r"}],"eIiSV":[function(require,module,exports) {
"use strict";
